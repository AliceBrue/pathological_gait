...
par_file_solLV = '../models/par_files/init_simple_swKF.par'
min_max_ratio = 0.01 # new max/min = value*(1 +/- min_max_ratio*sign(value))
...
# solLV model
key_dict_0 = {'key_name': 'KF', 'states': 'LateStance EarlyStance Liftoff', 'target': 'soleus',
              'source': None, 'key_values': [0.2,0.4,0.6,0.8,1.2,1.4,1.6,1.8]}

key_dict_1 = {'key_name': 'KF', 'states': 'Swing Landing', 'target': 'soleus',
              'source': None, 'key_values':  [1e4,1e5,1e6]}

key_dict_list = [ key_dict_0, key_dict_1 ]


output_folder_path = '../exports/geyer_solLV_multiobjective_stance_KF_swing_KF'
scone_base_files_path = '../models/cluster/geyer_solLV_multiobjective_base_files_prod'
